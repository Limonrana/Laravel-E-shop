...
@section('content')
    <main class="main">
        <div class="page-header page-header-bg" style="background-image: url('{{ asset('frontend/images/page-header-bg.jpg') }}');">
            <div class="container">
                <h1><span>ABOUT US</span>
                    OUR COMPANY</h1>
                <a href="{{ route('contact.page') }}" class="btn btn-dark">Contact</a>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
