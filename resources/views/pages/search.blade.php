...
@section('title', 'E-SHOP - Search Result')
...
@section('content')
    <main class="main">
        ...
        <div class="container">
            ...
            <div class="row row-sm" @if(count($product) == 0) style="padding-left: 15%;" @else @endif>
                ...
                @empty
                    <div class="no-search">
                        <img src="{{ asset('frontend/images/no-image/no_result.gif') }}" alt="">
                    </div>
                @endforelse
