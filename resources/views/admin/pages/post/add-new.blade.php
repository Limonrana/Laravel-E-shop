...
@section('title', 'Add New Post | E-SHOP')
@section('content')
<!-- ########## START: MAIN PANEL ########## -->
                ...
                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                    ...
                    <form class="mt-4" action="{{ route('admin.post.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('post_title_en') is-invalid @enderror" id="post_title_en" name="post_title_en" placeholder="Enter Post Title (English)" type="text">
                            @error('product_name')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('post_title_bn') is-invalid @enderror" id="post_title_bn" name="post_title_bn" placeholder="Enter Post Title (Bengali) - Optional" type="text">
                            @error('product_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="post_description_bn" class="form-control my-editor">{!! old('post_description_bn') !!}</textarea>
                        </div>
                        <div class="form-group">
