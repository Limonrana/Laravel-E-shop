...
@section('title', 'Out of Stock Products | E-SHOP')
...
@section('content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Out of Stock</span>
        </nav>
                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @empty
                            <td colspan="20" style="padding-top: 15%; padding-bottom: 15%;">
                                <h3 class="text-dark text-center">NO MORE OUT OF STOCK PRODUCT HERE</h3>
