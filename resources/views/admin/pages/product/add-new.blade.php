        ...
        <div class="row row-sm mg-t-20">
            <div class="col-xl-9">
                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                    ...
                    <form class="mt-4" action="{{ route('admin.product.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="product_name">Product Name</label>
                            <input class="form-control @error('product_name') is-invalid @enderror" id="product_name" name="product_name" placeholder="Enter Product Name" type="text">
                            @error('product_name')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('product_code') is-invalid @enderror" id="product_code" name="product_code" placeholder="Enter Product Code" type="text">
                                @error('product_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="product_quantity" name="product_quantity" placeholder="Enter Product Quantity" type="text">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control" data-role="tagsinput" id="product_size" name="product_size" type="text">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="product_name">Product Color</label>
                                <input class="form-control" data-role="tagsinput" id="product_color" name="product_color" type="text">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="product_name">Product Capacity</label>
                                <input class="form-control" data-role="tagsinput" id="product_capacity" name="product_capacity" type="text">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control @error('selling_price') is-invalid @enderror" id="selling_price" name="selling_price" placeholder="99.20" type="number">
                                    @error('selling_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon tx-size-sm lh-2">$</span>
                                    <input class="form-control" id="discount_price" name="discount_price" placeholder="99.20 (Optional)" type="number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="product_description">Description</label>
                            <textarea name="product_description" class="form-control my-editor">{!! old('product_description') !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="video_link">Video Link</label>
                            <input class="form-control" id="video_link" name="video_link" placeholder="Insert Video ID Exp:nflsf-0Kjf0" type="text">
                        </div><br>
                        <hr>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-4">
                                    <label class="ckbox">
                                        <input type="checkbox" name="header_slider" value="1"><span>Header Slider</span>
                                    </label>
                                </div><!-- col-3 -->
                            ...
                            <div class="row mg-t-10">
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    <label class="ckbox">
                                        <input type="checkbox" name="trend" value="1"><span>Trendy Product</span>
                                    </label>
                                </div><!-- col-3 -->
                            </div><!-- row -->
                        </div>
            ...
            <div class="col-xl-3 mg-t-25 mg-xl-t-0">
                <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
                    ...
                    <div class="form-row mt-3">
                        <div class="col-md-6">
                            <img id="gallery_image_1_show" width="150px" style="border: 1px solid black">
                        </div>
                        <div class="col-md-6">
                            <img id="gallery_image_2_show" width="150px" style="border: 1px solid black">
                        </div>
                    </div>
