                ...
                <form action="{{ route('admin.category.update', $category->id) }}" method="post">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('category_icon') is-invalid @enderror" id="category_icon" name="category_icon" value="{{ $category->category_icon }}" placeholder="Example: fa fa-phone">
                            @error('category_icon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
