...
@section('title', 'All Complete Orders | E-SHOP')
...
@section('content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Complete-Orders</span>
        </nav>

        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>All Complete Orders</h5>
            </div><!-- sl-page-title -->
                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @empty
                            <td colspan="20" style="padding-top: 15%; padding-bottom: 15%;">
                                <h3 class="text-dark text-center">NO MORE COMPLETE ORDER HERE</h3>
