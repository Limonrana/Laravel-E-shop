...
@section('title', 'All Confirm Orders | E-SHOP')
...
@section('content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <span class="breadcrumb-item active">Confirm-Orders</span>
        </nav>

        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>All Confirm Orders</h5>
            </div><!-- sl-page-title -->
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($val->status == 1)
                                    <span class="badge badge-info text-white p-1">Payment Confirm</span>
                                @else
                                @endif
                            </td>
                            <td>
